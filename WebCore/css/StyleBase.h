...
namespace WebCore {
    ...
    public:
        ...
        KURL baseURL() const;
                                                               //
        virtual bool isCSSStyleSheet() const { return false; } //is style sheet
        ...
        virtual bool isKeyframesRule() { return false; }       //is rule
        ...
        virtual bool isStyleSheet() const { return false; }    //is style sheet
        virtual bool isXSLStyleSheet() const { return false; } //

	virtual bool isMutableStyleDeclaration() const { return false; }

        virtual String cssText() const; /* 返回空字符窜 */
