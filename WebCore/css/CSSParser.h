...
namespace WebCore {
    ...
    public:
        ...
        bool parseValue(CSSMutableStyleDeclaration*, int propId, const String&, bool important);/* 解析一个属性对应的值 */
        ...
        bool parseValue(int propId, bool important); /* 解析一个属性对应的值 */
        ...
        bool m_important;
        int m_id;
        CSSStyleSheet* m_styleSheet; /* 当前正在解析的层叠样式表 */
    ...
    private:
        ...
        UChar* m_data;		/* 解析的字符串 */
        UChar* yytext;		/* 解析的字符串 */
        UChar* yy_c_buf_p;	/* 解析的字符串 */
        UChar yy_hold_char;	/* 当前正在扫描的字符 */
