...
public:
    ...
    RenderLayer* parent() const { return m_parent; } /* 父亲 */
    RenderLayer* previousSibling() const { return m_previous; } /* 上个兄弟 */
    RenderLayer* nextSibling() const { return m_next; }		/* 下个兄弟 */
    RenderLayer* firstChild() const { return m_first; }		/* 第一个孩子 */
    RenderLayer* lastChild() const { return m_last; }		/* 最后一个孩子 */

    void addChild(RenderLayer* newChild, RenderLayer* beforeChild = 0); /* 添加一个孩子 */
    RenderLayer* removeChild(RenderLayer*); /* 移出一个孩子 */
    ...
    const RenderLayer* root() const /* 返回root layer */
    {
    ...
    void resize(const PlatformMouseEvent&, const IntSize&); /* 改变大小 */
    bool inResizeMode() const { return m_inResizeMode; }
    void setInResizeMode(bool b) { m_inResizeMode = b; }

    bool isRootLayer() const { return renderer()->isRenderView(); } /* 是否为root layer */
...
protected:
    ...
    RefPtr<Scrollbar> m_hBar; 	/* 水平滚动条 */
    RefPtr<Scrollbar> m_vBar;	/* 垂直滚动条 */
