...
public:
    ...
    virtual void adjustPosition(int dx, int dy); /* 调整inline box的坐标 */
...
public:
    ...
    InlineBox* nextOnLine() const { return m_next; } /* 同一行的下个inlinebox */
...
public:
    ...
    int m_x; /* the left side of the box in the parent's coordinate system. */
    int m_y; /*  the top of the box in the parent's coordinate system */
    int m_width;
