...
public:
    ...
    IntPoint point() const { return m_point; } /* 鼠标在全局的点(预先设置) */
    IntPoint localPoint() const { return m_localPoint; }
    Element* URLElement() const { return m_innerURLElement.get(); }
    Scrollbar* scrollbar() const { return m_scrollbar.get(); } /* 如果点击的是scrollbar,则可以得到 */
    ...
    void setScrollbar(Scrollbar*); /* 如果点击的是scrollbar，则设置 */
